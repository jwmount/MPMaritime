...
d           = Dataset.find code
  ...
  #
  d.description = 'Coastal European Gas Carrier, Fully Refrigerated xxx,600 cbm range.'
  d.description += " See also 'Coastal European Gas Carrier, Fully Refrigerated--Fleet History.' "
  d.name = "Coastal European Gas Carrier, Fully Refrigerated--Spot Contract Rates"
