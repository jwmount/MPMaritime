...
Quandl::Client.token = ENV['QUANDL_TOKEN']
  ...
  #
  d.name = "Coastal Asian Gas Carrier, Fully Refrigerated--Fleet History"
  d.description = 'Vessels in xx,600 - xx,000 cbm range.'
  d.description += " See also 'Coastal Asian Gas Carrier, Fully Refrigerated--Spot Contract Rates.' "
  #  
  d.save
