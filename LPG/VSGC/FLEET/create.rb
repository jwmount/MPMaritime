...
attributes = { 
    ...
    :code         => 'VSGC_SR_F',           # EDIT THIS dataset modifier of database name
    :column_names => ['Date', 'Deliveries', 'Deliveries(cbm)', 'Demolitions', 'Demolitions(cbm)', 'New Orders', 'New Orders(cbm)'],
    :data         => [],
    :frequency    => 'weekly',
    :name         => 'Very Small Gas Carrier Fleet, Semi Refrigerated',
    :private      => false,         # true do not show | false make visible
    :description  => 'Vessels of xx,000 cbm or larger.'
  }
